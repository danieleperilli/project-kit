...
1. `README.md`
2. `.project/CONTRIBUTING.md`
3. `.project/CHANGELOG.md`
4. `.project/CODE_STYLE.md`
5. `.project/context/overview.md`
6. `.project/context/architecture.md`
7. `.project/context/decisions.md`
8. The relevant feature spec under `.project/specs/`, if one exists
...
- If project config, linters, formatters, or existing conventions define a rule, those rules override `.project/CODE_STYLE.md`.
...
- Treat the `Core Functionality` section in `.project/context/overview.md` as the source of truth for behavior that should be protected by unit tests.
...
- Add or update a feature spec under `.project/specs/` only when the change is ambiguous, risky, or review-heavy.
- Append a dated note to `.project/context/decisions.md` when a technical or workflow decision becomes durable.
